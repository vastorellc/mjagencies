 ...
 *
 * Reusable Payload access-control functions for compliance collections.
 * Copied verbatim from packages/proposals/src/access/collection-access.ts to avoid
 * a circular dependency between cms and compliance packages (Phase 9 + Phase 10 pattern).
 *
