 ...
 *
 * Reusable Payload access-control functions for esign collections.
 * Copied from packages/cms/src/access/collection-access.ts to avoid
 * circular dependency — same pattern used in Phase 9 CRM package.
 *
