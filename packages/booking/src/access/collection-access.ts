 ...
 *
 * Reusable Payload access-control functions for all booking collections.
 * Copied verbatim from packages/crm/src/access/collection-access.ts to avoid
 * a circular dependency between cms/crm and booking packages.
 *
