...
- [ ] Worker on BOOKING_CANCELLED: updates activity status to 'cancelled'
...
## Commit message
feat(09-05): Cal.com webhook receiver, HMAC+idempotency, booking CRM worker, /booking page with inline embed
