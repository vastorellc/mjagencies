/**
 * apps/web-growth/src/app/(frontend)/contact/page.tsx
 *
 * Contact page for the growth agency.
...
const AGENCY_ID = process.env['NEXT_PUBLIC_AGENCY_SLUG'] ?? 'growth'
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJAgency Growth'
  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 'var(--mj-space-10)' }}>
        ...
        >
          Ready to accelerate your growth? Send us a message and we&apos;ll get back to you
