...
export const metadata: Metadata = {
  title: 'Terms of Service — MJ Growth Agency',
  robots: { index: false },
}
      ...
      <main id="main-content" style={{ padding: 'var(--mj-space-16) var(--mj-space-6)', maxWidth: '800px' }}>
        ...
        <section style={{ marginTop: 'var(--mj-space-8)' }}>
          ...
          <p style={{ color: 'var(--mj-color-text-secondary)', lineHeight: 'var(--mj-leading-relaxed)' }}>
            MJ Growth Agency provides professional services under the terms of a separately executed Statement of Work. These terms govern use of our website and general engagement inquiries.
          </p>
        </section>
        <section style={{ marginTop: 'var(--mj-space-8)' }}>
