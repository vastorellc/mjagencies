...
const AGENCY_ID = 'construction'

export const revalidate = 60

export const metadata: Metadata = {
  title: 'MJ Construction Agency — Marketing that drives results',
...
export default async function HomePage(): Promise<React.ReactElement> {
  ...
  const headline = page?.title ?? 'MJ Construction Agency'
  const subheadline = page?.aio_tldr ?? 'Construction marketing — bid pipelines, contractor SEO, residential and commercial growth.'
