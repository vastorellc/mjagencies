 ...
 *
 * Contact page for the ecommerce agency.
...
const AGENCY_ID = process.env['NEXT_PUBLIC_AGENCY_SLUG'] ?? 'ecommerce'
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJAgency Ecommerce'
  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 'var(--mj-space-10)' }}>
        ...
        >
          Ready to grow your ecommerce business? Send us a message and we&apos;ll get back to you
