...
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJ Ecommerce'
const AGENCY_DOMAIN = process.env['NEXT_PUBLIC_AGENCY_DOMAIN'] ?? 'web-ecommerce.mjagency.com'
