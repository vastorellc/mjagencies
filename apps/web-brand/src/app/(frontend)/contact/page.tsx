/**
 * apps/web-brand/src/app/(frontend)/contact/page.tsx
 *
 * Contact page for the brand agency.
...
const AGENCY_ID = process.env['NEXT_PUBLIC_AGENCY_SLUG'] ?? 'brand'
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJAgency Brand'
  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 'var(--mj-space-10)' }}>
        ...
        >
          Ready to build a brand that stands out? Send us a message and we&apos;ll get back to you
