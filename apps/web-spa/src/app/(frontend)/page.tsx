...
export const metadata: Metadata = {
  title: 'MJ Spa Agency — Marketing that drives results',
...
export default async function HomePage(): Promise<React.ReactElement> {
  ...
  const headline = page?.title ?? 'MJ Spa Agency'
  const subheadline = page?.aio_tldr ?? 'Spa and wellness marketing — membership growth, treatment packages, and retention for day spas, med spas, and salons.'
