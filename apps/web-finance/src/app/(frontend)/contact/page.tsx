/**
 * apps/web-finance/src/app/(frontend)/contact/page.tsx
 *
 * Contact page for the finance agency.
...
const AGENCY_ID = process.env['NEXT_PUBLIC_AGENCY_SLUG'] ?? 'finance'
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJAgency Finance'
  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 'var(--mj-space-10)' }}>
        ...
        >
          Ready to strengthen your financial position? Send us a message and we&apos;ll get back to
