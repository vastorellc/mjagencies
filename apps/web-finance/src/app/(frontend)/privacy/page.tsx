...
export const metadata: Metadata = {
  title: 'Privacy Policy — MJ Finance Agency',
  robots: { index: false },
}
      ...
      <main id="main-content" style={{ padding: 'var(--mj-space-16) var(--mj-space-6)', maxWidth: '800px' }}>
        ...
        <section style={{ marginTop: 'var(--mj-space-8)' }}>
          ...
          <p style={{ color: 'var(--mj-color-text-secondary)', lineHeight: 'var(--mj-leading-relaxed)' }}>
            MJ Finance Agency collects information you provide directly, including name, email address, and project details via our contact form. We also collect analytics data to improve our website.
          </p>
        </section>
        <section style={{ marginTop: 'var(--mj-space-8)' }}>
          ...
          <p style={{ color: 'var(--mj-color-text-secondary)', lineHeight: 'var(--mj-leading-relaxed)' }}>
            You may request access, correction, or deletion of your personal data by emailing privacy@finance.mjagency.com. We will respond within 30 days.
          </p>
        </section>
      </main>
    </>
