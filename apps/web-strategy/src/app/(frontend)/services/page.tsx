...
export const metadata: Metadata = {
  title: 'Business Strategy Services — MJ Strategy Agency',
  description: 'Market entry, competitive positioning, growth strategy, OKR design, M&A preparation, and strategic advisory for companies navigating critical inflection points.',
}
  ...
  return (
    <>
      ...
      <main id="main-content" style={{ padding: 'var(--mj-space-16) var(--mj-space-6)' }}>
        <h1 style={{ fontSize: 'var(--mj-text-size-4xl)', fontWeight: 'var(--mj-weight-bold)', color: 'var(--mj-color-text-primary)', fontFamily: 'var(--mj-font-heading)' }}>Business Strategy Services</h1>
        {services.length === 0 ? (
          <p style={{ color: 'var(--mj-color-text-secondary)', marginTop: 'var(--mj-space-8)' }}>
            We deliver market entry, competitive positioning, and growth strategy for companies at inflection points — fundraise, expansion, pivot, or exit.{' '}
            <a href="/contact" style={{ color: 'var(--mj-color-brand-500)' }}>Contact us</a> to discuss your strategic challenge.
          </p>
        ) : (
