 ...
 *
 * Tool landing page route for the automotive agency.
 * REQ-413: result is inline — NOT a separate indexed page.
 * REQ-124: benchmark expiry checked per tool.
 * ISR: generateStaticParams() pre-renders all 3 automotive tools at build time.
 */
