...
export const metadata: Metadata = {
  metadataBase: new URL(process.env['NEXT_PUBLIC_SITE_URL'] ?? 'https://ai.mjagency.com'),
...
export default async function FrontendLayout({
  ...
  return (
    <html lang="en">
      <body>
        <SiteNav agencyName="MJ AI Agency" />
        <ConsentProvider initial={consent}>
          ...
          <SiteFooter agencyName="MJ AI Agency" tagline="AI automation, LLM integration, and intelligent product development." />
        </ConsentProvider>
      </body>
    </html>
  )
