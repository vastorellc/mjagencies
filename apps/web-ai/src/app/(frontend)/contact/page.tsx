/**
 * apps/web-ai/src/app/(frontend)/contact/page.tsx
 *
 * Contact page for the AI agency.
...
const AGENCY_ID = process.env['NEXT_PUBLIC_AGENCY_SLUG'] ?? 'ai'
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJAgency AI'
  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 'var(--mj-space-10)' }}>
        ...
        >
          Ready to bring AI to your business? Send us a message and we&apos;ll get back to you
