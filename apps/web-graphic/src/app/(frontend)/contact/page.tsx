/**
 * apps/web-graphic/src/app/(frontend)/contact/page.tsx
 *
 * Contact page for the graphic design agency.
...
const AGENCY_ID = process.env['NEXT_PUBLIC_AGENCY_SLUG'] ?? 'graphic'
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJAgency Graphic'
  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 'var(--mj-space-10)' }}>
        ...
        >
          Ready to create visuals that captivate? Send us a message and we&apos;ll get back to you
