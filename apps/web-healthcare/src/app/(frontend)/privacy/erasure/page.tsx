...
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJ Healthcare'
const AGENCY_DOMAIN = process.env['NEXT_PUBLIC_AGENCY_DOMAIN'] ?? 'web-healthcare.mjagency.com'
