/**
 * apps/web-webdev/src/app/(frontend)/contact/page.tsx
 *
 * Contact page for the web development agency.
...
const AGENCY_ID = process.env['NEXT_PUBLIC_AGENCY_SLUG'] ?? 'webdev'
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJAgency Web Dev'
  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 'var(--mj-space-10)' }}>
        ...
        >
          Ready to build something great? Send us a message and we&apos;ll get back to you
