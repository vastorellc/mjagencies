...
export const metadata: Metadata = {
  title: 'Web Development Services — MJ Web Dev Agency',
  description: 'Custom web applications, headless CMS builds, Next.js sites, e-commerce development, and web performance engineering for companies that need polished, fast, and maintainable web presence.',
}
  ...
  return (
    <>
      ...
      <main id="main-content" style={{ padding: 'var(--mj-space-16) var(--mj-space-6)' }}>
        <h1 style={{ fontSize: 'var(--mj-text-size-4xl)', fontWeight: 'var(--mj-weight-bold)', color: 'var(--mj-color-text-primary)', fontFamily: 'var(--mj-font-heading)' }}>Web Development Services</h1>
        {services.length === 0 ? (
          <p style={{ color: 'var(--mj-color-text-secondary)', marginTop: 'var(--mj-space-8)' }}>
            We build custom websites, headless CMS platforms, and web applications in Next.js and TypeScript — fast, accessible, and built to last.{' '}
            <a href="/contact" style={{ color: 'var(--mj-color-brand-500)' }}>Contact us</a> to discuss your web project.
          </p>
        ) : (
