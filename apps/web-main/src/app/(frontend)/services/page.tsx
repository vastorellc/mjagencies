...
export const metadata: Metadata = {
  title: 'Agency Services — MJ Agency',
  description: 'Full-spectrum agency services across AI, branding, ecommerce, engineering, finance, graphic design, growth, product, strategy, video, and web development — delivered as a coordinated multi-service program.',
}
  ...
  return (
    <>
      ...
      <main id="main-content" style={{ padding: 'var(--mj-space-16) var(--mj-space-6)' }}>
        <h1 style={{ fontSize: 'var(--mj-text-size-4xl)', fontWeight: 'var(--mj-weight-bold)', color: 'var(--mj-color-text-primary)', fontFamily: 'var(--mj-font-heading)' }}>Agency Services</h1>
        {services.length === 0 ? (
          <p style={{ color: 'var(--mj-color-text-secondary)', marginTop: 'var(--mj-space-8)' }}>
            MJ Agency delivers integrated programs across 11 specialist verticals — from AI integration to brand identity to ecommerce and engineering.{' '}
            <a href="/contact" style={{ color: 'var(--mj-color-brand-500)' }}>Contact us</a> to design a program that matches your scale and goals.
          </p>
        ) : (
