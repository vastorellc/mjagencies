/**
 * apps/web-video/src/app/(frontend)/contact/page.tsx
 *
 * Contact page for the video agency.
...
const AGENCY_ID = process.env['NEXT_PUBLIC_AGENCY_SLUG'] ?? 'video'
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJAgency Video'
  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 'var(--mj-space-10)' }}>
        ...
        >
          Ready to tell your story through video? Send us a message and we&apos;ll get back to you
