/**
 * apps/web-branding/src/app/(frontend)/contact/page.tsx
 *
 * Contact page for the branding agency.
...
const AGENCY_ID = process.env['NEXT_PUBLIC_AGENCY_SLUG'] ?? 'branding'
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJAgency Branding'
  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 'var(--mj-space-10)' }}>
        ...
        >
          Ready to define your brand identity? Send us a message and we&apos;ll get back to you
