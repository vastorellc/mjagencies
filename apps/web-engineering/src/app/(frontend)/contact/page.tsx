/**
 * apps/web-engineering/src/app/(frontend)/contact/page.tsx
 *
 * Contact page for the engineering agency.
...
const AGENCY_ID = process.env['NEXT_PUBLIC_AGENCY_SLUG'] ?? 'engineering'
const AGENCY_NAME = process.env['NEXT_PUBLIC_AGENCY_NAME'] ?? 'MJAgency Engineering'
  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: 'var(--mj-space-10)' }}>
        ...
        >
          Ready to ship with confidence? Send us a message and we&apos;ll get back to you
